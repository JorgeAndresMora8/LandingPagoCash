    ...
    <div className="nuestrosValoresContainer" id='nuestrosValores'>
            ...
            <div className="nuestrosValoresItemContainer">
                ...
                <div className="nuestrosValoresItem">
                    ...
                    <p className="nuestrosValoresItemText">Innovamos cada día para traerte una plataforma actual y funcional.</p>
                </div>
                ...
                <FontAwesomeIcon className="fa-2x valoresIcons" style={{backgroundColor:'#0E4A7C', color:'#fff'}} icon={faLock} />
                    ...
                    <p className="nuestrosValoresItemText">Utilizamos información encriptada para proteger la privacidad.</p>
                </div>
            </div>
            <div className="nuestrosValoresWalletContainer">
                ...
                <img src="/PagocashLogoWhite.png" style={{width:'70%', height:'auto'}} alt="" />
                    ...
                    <b className='title' style={{color:'#fff'}}>Comienza a utilizar <br></br>nuestra wallet.</b>
                    </div>
                    
                </div>
                <div className="nuestrosValoresWalletContent">
                    <p>Junto a pagocash contamos con features y opciones que pueden ayudarte a la hora de manejar tu dinero de manera fácil y segura. También cuentas 
                        Con la disponibilidad de enviar dinero a quien quieras que esté registrado en la plataforma.
                    </p>
